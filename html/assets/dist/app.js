...
function latticeCalculation(latticetype, latticeparams) {
    if (latticetype == "oblique") {
        var latticeConstantA = latticeparams[0];
        var latticeConstantB = latticeparams[1];
        var unitAngle = latticeparams[2];
        var latticeAngle = unitAngle == "rad" ? latticeparams[3] : 0.0174533 * latticeparams[3];
    }
}
